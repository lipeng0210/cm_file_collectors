<template>
    <div :class="Class_C" v-if="props.mode == 'simple'">
        <performerComSubA :performerInfo="props.performerInfo" @showPerRes="showPerRes" :performer="$props.performer">
        </performerComSubA>
    </div>
    ...
    <div v-else :class="Class_C">
        <el-popover placement="left" width="380" trigger="click">
            ...
            <template #reference>
                <performerComSubA :performerInfo="props.performerInfo" @showPerRes="showPerRes"
                    :performer="$props.performer"></performerComSubA>
            </template>
        </el-popover>
    </div>
</template>
